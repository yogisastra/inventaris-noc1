            ...
            <form action="barang_update.php" method="post">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <select class="form-control" name="lokasi" required="required">
                  ...
                  <option value="Ruang NOC">Ruang NOC</option>
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="sumber_dana" placeholder="Masukkan sumber_dana .." value="<?php echo $d['barang_sumber_dana'] ?>">
                </div>

                <div class="form-group">
                  <label>Keterangan</label>
                  <input type="text" class="form-control" name="keterangan" placeholder="Masukkan keterangan .." value="<?php echo $d['barang_keterangan'] ?>">
                </div>
