...
<head>
  ...
  <title>Administrator - Inventaris NOC</title>
  ...
  <link href='assets/noc.png' rel='shortcut icon'>\
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Inventaris</b> NOC</span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="data_stb.php"><i class="fa fa-folder"></i> <span>Data STB Root</span></li>
              <li><a href="data_sfp.php"><i class="fa fa-folder"></i> <span>Data SFP OLT</span></li>
              </ul>
            </li>
