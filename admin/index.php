    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $stb = mysqli_query($koneksi,"SELECT * FROM tb_stb");
            ?>
            <h3><?php echo mysqli_num_rows($stb); ?></h3>
            <p>Data STB</p>
          </div>
          <div class="icon">
            <i class="ion ion-stats-bars"></i>
          </div>
          <a href="data_stb.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $sfp = mysqli_query($koneksi,"SELECT * FROM tb_sfp");
            ?>
            <h3><?php echo mysqli_num_rows($sfp); ?></h3>
            <p>Data SFP OLT</p>
          </div>
          <div class="icon">
            <i class="ion ion-stats-bars"></i>
          </div>
          <a href="data_sfp.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
